...
class AutoBuySettings(Base):
    ...
    price_limit_from = Column(Integer, default=4999, nullable=False)
    price_limit_to = Column(Integer, default=50000, nullable=False)
    supply_limit = Column(Integer, default=10000)
